...
const fetcher = (variables: { userId: number | null | undefined, newsId : number | null | undefined }) => axios.delete(SERVER_URL + API_URL,{ data: { userId: variables.userId, newsId : variables.newsId } } ).then(({ data }) => data)
